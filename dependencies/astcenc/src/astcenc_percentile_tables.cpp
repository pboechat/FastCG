...
static const packed_percentile_table block_pcd_4x4{
	4, 4, {61, 84}, {184, 141}, {0, 53}, {percentile_arr_4x4_0, percentile_arr_4x4_1}};
#endif
...
static const packed_percentile_table block_pcd_5x4{
	5, 4, {91, 104}, {322, 464}, {0, 202}, {percentile_arr_5x4_0, percentile_arr_5x4_1}};
#endif
...
static const packed_percentile_table block_pcd_5x5{
	5, 5, {129, 126}, {258, 291}, {0, 116}, {percentile_arr_5x5_0, percentile_arr_5x5_1}};
#endif
...
static const packed_percentile_table block_pcd_6x5{
	6, 5, {165, 145}, {388, 405}, {0, 156}, {percentile_arr_6x5_0, percentile_arr_6x5_1}};
#endif
...
static const packed_percentile_table block_pcd_6x6{
	6, 6, {206, 164}, {769, 644}, {0, 256}, {percentile_arr_6x6_0, percentile_arr_6x6_1}};
#endif
...
static const packed_percentile_table block_pcd_8x5{
	8, 5, {226, 167}, {763, 517}, {0, 178}, {percentile_arr_8x5_0, percentile_arr_8x5_1}};
#endif
...
static const packed_percentile_table block_pcd_8x6{
	8, 6, {273, 186}, {880, 300}, {0, 64}, {percentile_arr_8x6_0, percentile_arr_8x6_1}};
#endif
...
static const packed_percentile_table block_pcd_8x8{
	8, 8, {347, 208}, {1144, 267}, {0, 38}, {percentile_arr_8x8_0, percentile_arr_8x8_1}};
#endif
...
static const packed_percentile_table block_pcd_10x5{
	10, 5, {274, 180}, {954, 324}, {0, 79}, {percentile_arr_10x5_0, percentile_arr_10x5_1}};
#endif
...
static const packed_percentile_table block_pcd_10x6{
	10, 6, {325, 199}, {922, 381}, {0, 78}, {percentile_arr_10x6_0, percentile_arr_10x6_1}};
#endif
...
static const packed_percentile_table block_pcd_10x8 =
	{
		10, 8, {400, 221}, {1119, 376}, {0, 52}, {percentile_arr_10x8_0, percentile_arr_10x8_1}};
#endif
...
static const packed_percentile_table block_pcd_10x10{
	10, 10, {453, 234}, {1095, 472}, {0, 70}, {percentile_arr_10x10_0, percentile_arr_10x10_1}};
#endif
...
static const packed_percentile_table block_pcd_12x10 =
	{
		12, 10, {491, 240}, {1099, 341}, {0, 23}, {percentile_arr_12x10_0, percentile_arr_12x10_1}};
#endif
...
static const packed_percentile_table block_pcd_12x12{
	12, 12, {529, 246}, {1435, 335}, {0, 22}, {percentile_arr_12x12_0, percentile_arr_12x12_1}};
#endif
...
#if ASTCENC_BLOCK_MAX_TEXELS >= (4 * 4)
	case 0x0404:
		return &block_pcd_4x4;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (5 * 4)
	case 0x0405:
		return &block_pcd_5x4;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (5 * 5)
	case 0x0505:
		return &block_pcd_5x5;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (6 * 5)
	case 0x0506:
		return &block_pcd_6x5;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (6 * 6)
	case 0x0606:
		return &block_pcd_6x6;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (8 * 5)
	case 0x0508:
		return &block_pcd_8x5;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (8 * 6)
	case 0x0608:
		return &block_pcd_8x6;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (8 * 8)
	case 0x0808:
		return &block_pcd_8x8;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (10 * 5)
	case 0x050A:
		return &block_pcd_10x5;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (10 * 6)
	case 0x060A:
		return &block_pcd_10x6;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (10 * 8)
	case 0x080A:
		return &block_pcd_10x8;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (10 * 10)
	case 0x0A0A:
		return &block_pcd_10x10;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (12 * 10)
	case 0x0A0C:
		return &block_pcd_12x10;
#endif
#if ASTCENC_BLOCK_MAX_TEXELS >= (12 * 12)
	case 0x0C0C:
		return &block_pcd_12x12;
#endif
	}
