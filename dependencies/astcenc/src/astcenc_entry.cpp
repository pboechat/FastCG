 ...
 */
static const std::array<astcenc_preset_config, 6> preset_configs_high{{{ASTCENC_PRE_FASTEST,
 ...
 */
static const std::array<astcenc_preset_config, 6> preset_configs_mid{{{ASTCENC_PRE_FASTEST,
 ...
 */
static const std::array<astcenc_preset_config, 6> preset_configs_low{{{ASTCENC_PRE_FASTEST,
	...
	unsigned int flags)
{
	...
	exMask = ASTCENC_FLG_MAP_NORMAL | ASTCENC_FLG_MAP_RGBM;
