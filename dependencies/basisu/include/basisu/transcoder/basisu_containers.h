...
#define BASISU_HAS_DESTRUCTOR(T) ((!scalar_type<T>::cFlag) && (!__is_pod(T)))
   ...
   public:
      ...
      inline vector() : m_p(NULL),
                        m_size(0),
                        m_capacity(0)
      {
      }

      inline vector(uint32_t n, const T &init) : m_p(NULL),
                                                 m_size(0),
                                                 m_capacity(0)
      {
      ...
      inline vector(const vector &other) : m_p(NULL),
                                           m_size(0),
                                           m_capacity(0)
      {
      ...
      inline explicit vector(size_t size) : m_p(NULL),
                                            m_size(0),
                                            m_capacity(0)
      {
         resize(size);
   ...
   public:
      ...
      hash_map(const hash_map &other) : m_values(other.m_values),
