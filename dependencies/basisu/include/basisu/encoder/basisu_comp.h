...
#pragma once
#include "basisu/encoder/basisu_frontend.h"
#include "basisu/encoder/basisu_backend.h"
#include "basisu/encoder/basisu_basis_file.h"
#include "basisu/transcoder/basisu_transcoder.h"
#include "basisu/encoder/basisu_uastc_enc.h"
...
namespace basisu
{
	...
	struct param
	{
		param(T def, T min_v, T max_v) : m_value(def),
										 m_def(def),
										 m_min(min_v),
										 m_max(max_v),
										 m_changed(false)
	...
	{
		basis_compressor_params() : m_compression_level((int)BASISU_DEFAULT_COMPRESSION_LEVEL, 0, (int)BASISU_MAX_COMPRESSION_LEVEL),
