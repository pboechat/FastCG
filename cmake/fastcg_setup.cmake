...
if(DEFINED FASTCG_DEPLOY)
    ...
    set(FASTCG_DEPLOY_VALUE ${CMAKE_SOURCE_DIR}/deploy/${FASTCG_PLATFORM}/${FASTCG_GRAPHICS_SYSTEM})
endif()
set(FASTCG_DEPLOY ${FASTCG_DEPLOY_VALUE} CACHE PATH "FastCG deploy directory")
...
option(FASTCG_BUILD_EXAMPLES "Build examples" ON)
...
message(STATUS "FastCG - Build examples = ${FASTCG_BUILD_EXAMPLES}")
