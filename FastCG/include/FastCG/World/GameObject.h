...
namespace FastCG
{
    ...
    {
    public:
        static GameObject *Instantiate(const std::string &rName, const glm::vec3 &rScale = glm::vec3{1, 1, 1},
                                       const glm::quat &rRotation = {1, 0, 0, 0},
                                       const glm::vec3 &rPosition = glm::vec3{0, 0, 0});
    ...
    private:
        ...
        GameObject();
        GameObject(const std::string &rName, const glm::vec3 &rScale, const glm::quat &rRotation,
