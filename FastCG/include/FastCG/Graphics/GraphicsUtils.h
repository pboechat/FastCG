...
namespace FastCG
{
    ...
    FASTCG_DECLARE_SCOPED_ENUM(ShaderType, uint8_t, VERTEX, FRAGMENT, COMPUTE);
    FASTCG_DECLARE_SCOPED_ENUM(TextureType, uint8_t, TEXTURE_1D, TEXTURE_2D, TEXTURE_3D, TEXTURE_CUBE_MAP,
                               TEXTURE_2D_ARRAY);
    ...
    FASTCG_DECLARE_SCOPED_ENUM(TextureFormat, uint8_t, R32_SFLOAT, R16_SFLOAT, R16_UNORM, R8_UNORM, R32G32_SFLOAT,
                               R16G16_SFLOAT, R16G16_UNORM, R8G8_UNORM, R32G32B32_SFLOAT, R16G16B16_UNORM,
                               R16G16B16_SFLOAT, R8G8B8_UNORM, B8G8R8_UNORM, B10G11R11_UFLOAT_PACK32,
                               R32G32B32A32_SFLOAT, R16G16B16A16_UNORM, A2R10G10B10_UNORM_PACK32, R8G8B8A8_UNORM,
                               B8G8R8A8_UNORM, D24_UNORM_S8_UINT, D32_SFLOAT, X8_D24_UNORM_PACK32, D16_UNORM,
                               BC1_RGB_UNORM_BLOCK, BC1_RGBA_UNORM_BLOCK, BC2_UNORM_BLOCK, BC3_UNORM_BLOCK,
                               BC4_UNORM_BLOCK, BC4_SNORM_BLOCK, BC5_UNORM_BLOCK, BC5_SNORM_BLOCK, BC6H_UFLOAT_BLOCK,
                               BC6H_SFLOAT_BLOCK, BC7_UNORM_BLOCK, ASTC_4x4_UNORM_BLOCK, ASTC_5x4_UNORM_BLOCK,
                               ASTC_5x5_UNORM_BLOCK, ASTC_6x5_UNORM_BLOCK, ASTC_6x6_UNORM_BLOCK, ASTC_8x5_UNORM_BLOCK,
                               ASTC_8x6_UNORM_BLOCK, ASTC_8x8_UNORM_BLOCK, ASTC_10x5_UNORM_BLOCK, ASTC_10x6_UNORM_BLOCK,
                               ASTC_10x8_UNORM_BLOCK, ASTC_10x10_UNORM_BLOCK, ASTC_12x10_UNORM_BLOCK,
                               ASTC_12x12_UNORM_BLOCK);
    FASTCG_DECLARE_SCOPED_ENUM(PrimitiveType, uint8_t, TRIANGLES);
    FASTCG_DECLARE_SCOPED_ENUM(BlendFunc, uint8_t, NONE, ADD);
    FASTCG_DECLARE_SCOPED_ENUM(BlendFactor, uint8_t, ZERO, ONE, SRC_COLOR, DST_COLOR, SRC_ALPHA, DST_ALPHA,
    ...
    FASTCG_DECLARE_SCOPED_ENUM(StencilOp, uint8_t, KEEP, ZERO, REPLACE, INVERT, INCREMENT_AND_CLAMP, INCREMENT_AND_WRAP,
                               DECREMENT_AND_CLAMP, DECREMENT_AND_WRAP);
...
#define CASE_RETURN(x, y)                                                                                              \
    case TextureFormat::x:                                                                                             \
        ...
        default:
            FASTCG_THROW_EXCEPTION(Exception, "Couldn't get bytes per texel (format: %s)",
