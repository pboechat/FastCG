...
namespace FastCG
{
    ...
    enum class RenderGroup : uint8_t
    {
        ...
        RESERVED = 2,
        OPAQUE_MATERIAL = 3,
        TRANSPARENT_MATERIAL = (std::numeric_limits<RenderGroupInt>::max() / 2) + OPAQUE_MATERIAL,
    ...
    constexpr RenderGroupInt TRANSPARENT_MATERIAL_ORDER_SPACE = (RenderGroupInt)RenderGroup::SKYBOX - (RenderGroupInt)RenderGroup::TRANSPARENT_MATERIAL;
