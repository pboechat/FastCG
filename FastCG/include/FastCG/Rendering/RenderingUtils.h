...
namespace FastCG
{
    ...
    constexpr RenderGroupInt OPAQUE_MATERIAL_ORDER_SPACE =
        (RenderGroupInt)RenderGroup::TRANSPARENT_MATERIAL - (RenderGroupInt)RenderGroup::OPAQUE_MATERIAL;
    constexpr RenderGroupInt TRANSPARENT_MATERIAL_ORDER_SPACE =
        (RenderGroupInt)RenderGroup::LAST - (RenderGroupInt)RenderGroup::TRANSPARENT_MATERIAL;
