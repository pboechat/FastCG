...
namespace FastCG
{
    ...
    protected:
        ...
        {
            RegisterInspectableProperty(this, "Diffuse Color", &Light::GetDiffuseColor, &Light::SetDiffuseColor,
                                        glm::vec4{0, 0, 0, 0}, glm::vec4{1, 1, 1, 1});
            RegisterInspectableProperty(this, "Specular Color", &Light::GetSpecularColor, &Light::SetSpecularColor,
                                        glm::vec4{0, 0, 0, 0}, glm::vec4{1, 1, 1, 1});
