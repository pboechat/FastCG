...
namespace FastCG
{
	...
	private:
		...
		OpenGLTexture *mpDiffuseTexture{nullptr};
		OpenGLTexture *mpNormalTexture{nullptr};
		OpenGLTexture *mpSpecularTexture{nullptr};
		OpenGLTexture *mpTangentTexture{nullptr};
		OpenGLTexture *mpExtraDataTexture{nullptr};
		OpenGLTexture *mpDepthTexture{nullptr};
		OpenGLTexture *mpFinalTexture{nullptr};
		OpenGLTexture *mpSSAOTexture{nullptr};
		OpenGLTexture *mpSSAOBlurTexture{nullptr};
