...
namespace FastCG
{
    OpenGLLineStrip::~OpenGLLineStrip()
    {
        DeallocateResources();
    }

    void OpenGLLineStrip::AllocateResources()
    {
    ...
    void OpenGLLineStrip::DeallocateResources()
    {
    ...
    void OpenGLLineStrip::Draw()
    {
        ...
        glBindVertexArray(mVertexArrayId);
        glDrawArrays(GL_LINE_STRIP, 0, (GLsizei)GetVertices().size());
        glBindVertexArray(0);
    }
